...
Either specify options.terrainProvider instead or set options.baseLayerPicker to true."
  ...
  if (
    ...
    //【世纪空间 ATGlobe】 统一toolbar
    // fullscreenContainer.className = "cesium-viewer-fullscreenContainer";
    // viewerContainer.appendChild(fullscreenContainer);
    fullscreenContainer.className = 'cesium-button cesium-toolbar-button ';
    toolbar.appendChild(fullscreenContainer);
    //【世纪空间 ATGlobe】 统一toolbar
  ...
  if (options.vrButton) {
    ...
    vrContainer.className = 'cesium-button cesium-toolbar-button ';
    toolbar.appendChild(vrContainer);
    //【世纪空间 ATGlobe】 统一toolbar
...
Viewer.prototype.destroy = function () {
  ...
  if (defined(this._fullscreenButton)) {
    ...
    this._toolbar.removeChild(this._fullscreenButton.container); //【世纪空间 ATGlobe】 this._element 改为 this._toolbar，解决销毁地球报错问题
  ...
  if (defined(this._vrButton)) {
    ...
    this._toolbar.removeChild(this._vrButton.container);  //【世纪空间 ATGlobe】 this._element 改为 this._toolbar，解决销毁地球报错问题
