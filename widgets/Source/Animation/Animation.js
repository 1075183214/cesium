...
const svgIconsById = {
  ...
  animation_pathPointer: {
    tagName: "path",
    //【世纪空间 ATGlobe】修改时间轴样式
    d: "m1,-98c7.732,0 14,6.268 14,14c0,7.732 -6.268,14 -14,14c-7.732,0 -14,-6.268 -14,-14c0,-7.732 6.268,-14 14,-14z",
...
function setShuttleRingPointer(shuttleRingPointer, knobOuter, angle) {
  ...
  shuttleRingPointer.setAttribute("stroke-width", "2px");
  shuttleRingPointer.setAttribute("stroke", "rgb(255, 255, 255)");
  shuttleRingPointer.setAttribute("fill-rule", "evenodd");
  //【世纪空间 ATGlobe】 修改时间轴样式
...
<div class="cesium-animation-themeSwooshHover"></div>';
  ...
  const shuttleRingSwooshG = svgFromObject({
    ...
    children: [
      ...
      {
        tagName: "circle",
        class: "cesium-animation-shuttleRingSwoosh-circle",
        cx: 100,
        cy: 15,
        r: 13,
      },
  ...
  /**
     ...
     * 修改罗盘日期、速度、状态等文字的位置
     */
  this._knobDate = svgText(0, -32, "");
  this._knobTime = svgText(0, -14, "");
  this._knobStatus = svgText(0, -51, "");
